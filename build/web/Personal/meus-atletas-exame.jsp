            ...
            <table class="table table-responsive">
                <thead>
                    <tr>
                        ...
                        <th>Objetivo</th>
                        <th>Alimentação</th>
                        <th>Cadastrar avaliação</th>
                        <th>Listar avaliação</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info" href="${pageContext.request.contextPath}/ControleAvaliacaoFisica?acao=consultar&atletaId=<%=atleta.getId()%>">
